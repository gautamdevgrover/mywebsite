...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative pt-20 pb-10 sm:pt-28 md:pt-40 md:pb-28 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6 md:space-y-8 text-left">
            ...
            <motion.div
              ...
              className="inline-flex flex-wrap items-center gap-2 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full border border-cyan-500/20 bg-cyan-500/5 backdrop-blur-md"
            >
              ...
              <span className="text-[11px] sm:text-xs font-mono text-cyan-400 font-semibold hidden sm:inline">
                CKA Certified
              </span>
            </motion.div>
            ...
            <div className="space-y-1 sm:space-y-2">
              <h1 className="tracking-tight">
                ...
                <motion.span
                  ...
                  className="block text-xl sm:text-3xl md:text-4xl lg:text-[2.6rem] font-medium text-slate-300/90 leading-snug"
                >
                ...
                <motion.span
                  ...
                  className="block text-2xl sm:text-5xl md:text-6xl lg:text-[3.85rem] font-black text-white leading-[1.1] mt-1.5 sm:mt-3"
                >
                  I Build the{" "}
            ...
            <motion.p
              ...
              className="text-sm sm:text-lg md:text-xl text-slate-300/90 max-w-2xl leading-relaxed font-normal"
            >
            ...
            <motion.div
              ...
              className="flex flex-wrap items-center gap-x-2.5 sm:gap-x-3 gap-y-1 text-[11px] sm:text-sm font-mono text-slate-400 pt-0.5 sm:pt-1"
            >
            ...
            >
              ...
              <Link
                href="/about#contact"
                className="group relative inline-flex items-center justify-center gap-2 px-4 py-3 sm:px-6 sm:py-3.5 rounded-xl text-xs sm:text-sm font-semibold tracking-wider uppercase text-white bg-gradient-to-r from-cyan-500 to-indigo-600 hover:from-cyan-400 hover:to-indigo-500 shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/30 transition-all active:scale-[0.98]"
              >
              ...
              <Link
                href="#capabilities"
                className="inline-flex items-center justify-center gap-1.5 px-4 py-3 sm:px-6 sm:py-3.5 rounded-xl text-xs sm:text-sm font-medium tracking-wide text-slate-300 hover:text-white bg-white/[0.03] hover:bg-white/[0.08] border border-white/10 hover:border-white/20 transition-all active:scale-[0.98]"
              >
            ...
            <motion.div
              ...
              className="pt-1 sm:pt-2 flex items-center gap-4 sm:gap-6 text-[11px] sm:text-xs text-slate-500 font-mono"
            >
      ...
      <div className="flex justify-center mt-6 md:mt-16">
        <a
          ...
          className="p-1.5 sm:p-2 rounded-full border border-white/10 text-slate-500 hover:text-cyan-400 hover:border-cyan-500/40 transition-colors animate-bounce"
        >
