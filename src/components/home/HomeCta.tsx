...
export const HomeCta: React.FC = () => {
  return (
    <section className="py-12 sm:py-20 border-t border-white/5 relative overflow-hidden bg-gradient-to-b from-transparent via-cyan-950/10 to-transparent">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 text-xs font-mono mb-4 sm:mb-6">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 max-w-md sm:max-w-none mx-auto">
          <Link
            href="/about#contact"
            className="group inline-flex items-center justify-center gap-2.5 px-6 sm:px-7 py-3 sm:py-4 rounded-xl text-xs sm:text-sm font-semibold tracking-wider uppercase text-white bg-gradient-to-r from-cyan-500 to-indigo-600 hover:from-cyan-400 hover:to-indigo-500 shadow-xl shadow-cyan-500/25 transition-all active:scale-[0.98]"
          >
          ...
          <Link
            href="/about"
            className="inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3 sm:py-4 rounded-xl text-xs sm:text-sm font-medium text-slate-300 hover:text-white bg-white/5 hover:bg-white/10 border border-white/10 transition-all"
          >
            <span>Read Founder Story &amp; Services</span>
          </Link>
        </div>

        <div className="mt-6 pt-6 sm:mt-8 sm:pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-center gap-2.5 sm:gap-6 text-xs font-mono text-slate-400">
