...
export const TechStrip: React.FC = () => {
  ...
  return (
    <section
      id="tech-strip"
      className="py-8 border-y border-white/5 bg-[#090C14]/70 backdrop-blur-sm relative overflow-hidden select-none"
    >
          ...
          {marqueeItems.map((tech, index) => {
            ...
            return (
              <div
                ...
                className={`group relative flex items-center gap-3 px-4 py-2.5 rounded-xl bg-white/[0.02] border border-white/5 transition-all duration-200 hover:bg-white/[0.06] hover:border-white/20 cursor-default ${tech.accent}`}
              >
                ...
                <div className="flex flex-col text-left whitespace-nowrap">
                  <span className="text-xs font-semibold text-white tracking-wide group-hover:text-cyan-300 transition-colors">
                    {tech.name}
                  </span>
